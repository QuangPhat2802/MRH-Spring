...
<body class="d-flex flex-column h-100">
	<div class="container-fluid">
		<div class="top-banner row">
			<img class="mx-auto" src="../resources/static/images/Tragop-1200-44-1200x44-1.png" />
		</div>
	</div>
	<header>
		<div class="container">
	...
	<main class="container">
		<div class="row mixed-content ">
				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner">
					  	<div class="carousel-item active">
							<img class="d-block w-100" src="../resources/static/images/03_07_2020_15_50_29_SONY-TV--690-300-(1).png" alt="First slide">
					  	</div>
					  	<div class="carousel-item">
							<img class="d-block w-100" src="../resources/static/images/TCL-TV-690-300-690x300.png" alt="Second slide">
					  	</div>
					  	<div class="carousel-item">
							<img class="d-block w-100" src="../resources/static/images/690-300-690x300-15.png" alt="Third slide">
					  	</div>
					  	<div class="carousel-item">
							<img class="d-block w-100" src="../resources/static/images/BIG-MG-690-300-690x300-1.png" alt="Third slide">
					  	</div>
						</div>
			...
			<div class="hot-news">
				...
				<div>
					<img src="../resources/static/images/26064-260x64.png"/>
					<img src="../resources/static/images/260X64.pngdesk-260x64.png"/>
					<img src="../resources/static/images/StickyBannerTCL-2-260x64.png"/>
				</div>
			</div>
		</div>
		<section class="row top-deal">
			<div class="mt-2"><img class="w-100" src="../resources/static/images/vunggiasocdesk-1200x80.png"></div>
							...
							<ul>
								<li class="product-info">
									<div class="prod-avatar">
										<img  src="../resources/static/images/lg-rn7-1-600x600.jpg">
									</div>
									<div class="prod-deal">
										<img src="../resources/static/images/giamsoc_optimized.png">
									</div>
									<div class="prod-name">
								...
								<li class="product-info">
									...
									<div class="prod-avatar">
										<img src="../resources/static/images/tcl-40s6500-550x340.jpg">
									</div>
									<div class="prod-deal">
									</div>
									<div class="prod-name">
								...
								<li class="product-info">
									...
									<div class="prod-avatar">
										<img  src="../resources/static/images/panasonic-nr-ba229pkvn-300x300.jpg">
									</div>
									<div class="prod-deal">
								...
								<li class="product-info">
									<div class="prod-avatar">
										<img  src="../resources/static/images/may-giat-samsung-ww90j54e0bw-sv-dd-300x300.jpg">
									</div>
									<div class="prod-deal">
										<img src="images/online-giảm-sốc-1x.png">
									</div>
								...
								<li class="product-info">
									...
									<div class="prod-avatar">
										<img  src="../resources/static/images/may-lanh-beko-rsvc09vs-5-550x160.jpg">
									</div>
									<div class="prod-deal">
										<img src="../resources/static/images/giamsoc_optimized.png">
									</div>
								...
								<li class="product-info">
									...
									<div class="prod-avatar">
										<img  src="../resources/static/images/midea-ac120-16ar-13-300x300.jpg">
									</div>
									<div class="prod-deal">
										<img src="images/online-giảm-sốc-1x.png">
									</div>
		...
		<section class="row ads-area">
			<img src="../resources/static/images/CHUYENTRANGKANG4-394x76.jpg">
			<img src="../resources/static/images/HERUCRO-06-394x76.jpg">
			<img src="../resources/static/images/HERUCRO-01-394x76.jpg">
		</section>
				...
				<div class="col-sm-7">
					<a class="hero-video">
						<div class="video-image btn-play-video" data-youtube-url="https://www.youtube.com/embed/dR6Xrs7_zAc">
							<img src="../resources/static/images/maxresdefault.jpg">
						</div>
				...
				<div class="col-sm-5 other-videos pl-0">
					<a class="row video-item">
						<div class="col-sm-3 video-image px-0 btn-play-video" data-youtube-url="https://www.youtube.com/embed/BQ3s5XjsJ7c">
							<img src="../resources/static/images/hqdefault.jpg">
						</div>
						<div class="col-sm-9 video-title">Top 10 máy giặt bán chạy nhất Điện máy XANH năm 2019</div>
					</a>
					<a class="row video-item">
						<div class="col-sm-3 video-image px-0 btn-play-video" data-youtube-url="https://www.youtube.com/embed/BQ3s5XjsJ7c">
							<img src="../resources/static/images/hqdefault%20(1).jpg">
						</div>
					...
					<a class="row video-item">
						<div class="col-sm-3 video-image px-0">
							<img src="../resources/static/images/top-10-quat-dieu-hoa-ban-chay-nhat-thang-05-2020-t-665x320.jpg">
						</div>
						<div class="col-sm-9 video-title">Top 10 quạt điều hòa bán chạy nhất tháng 05/2020 tại Điện máy XANH</div>
					</a>
					<a class="row video-item">
						<div class="col-sm-3 video-image px-0">
							<img src="../resources/static/images/top-5-may-giat-cua-truoc-ban-chay-nhat-thang-05-20-1-665x320.jpg">
						</div>
						<div class="col-sm-9 video-title">Top 5 Máy giặt cửa trước bán chạy nhất tháng 05/2020 tại Điện máy XANH</div>
					</a>
					<a class="row video-item">
						<div class="col-sm-3 video-image px-0">
							<img src="../resources/static/images/top-5-may-giat-cua-tren-ban-chay-nhat-thang-05-202-2-665x320.jpg">
						</div>
	...
	<div id="online-support">
		<a href="#">
			<img src="../resources/static/images/iconinvitechat_2.v201901000046.png">
